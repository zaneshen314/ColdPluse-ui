...
const UserCharityList = () => {
    const events = [
        { title: 'Event 1', date: '2023-10-01', venue: 'Venue 1', description: 'Description 1DescriptionDes cript i onDescriptio nDescriptionDescriptionDescriptionDescriptionDescriptionDescriptionDescriptionDescriptionDescriptionDescriptionDescription', point: 10 },
